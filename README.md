...
A work arround with the 6.0.0 version is to get the **Boostraper.php** file in the **EcclesiaCRM** folder and to put it the **your EcclesiaCRM folder** on your web server. 
