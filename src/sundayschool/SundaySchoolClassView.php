...
<div class="box">
  ...
  ?>
    <a class="btn btn-app makeCheckOut" id="makeCheckOut" data-makecheckoutgroupid="<?= $iGroupId ?>"> <i class="fa fa-cart-arrow-down"></i> <span class="cartActionDescription"><?= gettext('Make Check-out') ?></span></a>
  ...
  ?>
    <a class="btn btn-app makeCheckOut <?= (count($thisClassChildren) == 0)?"disabled":"" ?>" id="makeCheckOut" data-makecheckoutgroupid="<?= $iGroupId ?>"> <i class="fa fa-calendar-check-o"></i> <span class="cartActionDescription"><?= gettext('Make Check-out') ?></span></a>
  ...
  ?>
  <?php
    if (Cart::TeacherInCart($iGroupId)) {
  ?>
