...
$app->group('/menulinks', function (RouteCollectorProxy $group) {
  ...
  $group->post('/{userId:[0-9]+}', 'getMenuLinksForUser' );
  $group->post('/delete', 'deleteMenuLink' );
  $group->post('/upaction', 'upMenuLink' );
  $group->post('/downaction', 'downMenuLink' );
  $group->post('/create', 'createMenuLink' );
  $group->post('/set', 'setMenuLink' );
  $group->post('/edit', 'editMenuLink' );
