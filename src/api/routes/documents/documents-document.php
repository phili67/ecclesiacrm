...
$app->group('/document', function (RouteCollectorProxy $group) {
    ...
    $group->post('/create', 'createDocument' );
    $group->post('/get', 'getDocument' );
    $group->post('/update', 'updateDocument' );
    $group->post('/delete', 'deleteDocument' );
    $group->post('/leave', 'leaveDocument' );
