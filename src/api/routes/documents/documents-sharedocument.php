...
$app->group('/sharedocument', function (RouteCollectorProxy $group) {
    ...
    $group->post('/getallperson', 'getAllShareForPerson' );
    $group->post('/addperson', 'addPersonToShare' );
    $group->post('/addfamily', 'addFamilyToShare' );
    $group->post('/addgroup', 'addGroupToShare' );
    $group->post('/deleteperson', 'deletePersonFromShare' );
    $group->post('/setrights', 'setRightsForPerson' );
    $group->post('/cleardocument', 'clearDocument' );

});


function getAllShareForPerson(Request $request, Response $response, array $args) {
...
function addPersonToShare (Request $request, Response $response, array $args) {
  $params = (object)$request->getParsedBody();
...
function addGroupToShare (Request $request, Response $response, array $args) {
  $params = (object)$request->getParsedBody();
...
function deletePersonFromShare (Request $request, Response $response, array $args) {
  $params = (object)$request->getParsedBody();
...
function setRightsForPerson (Request $request, Response $response, array $args) {
  $params = (object)$request->getParsedBody();
...
function clearDocument (Request $request, Response $response, array $args) {
  $params = (object)$request->getParsedBody();
