...
$app->group('/filemanager', function (RouteCollectorProxy $group) {
    ...
    $group->post('/{personID:[0-9]+}', FileManagerController::class . ':getAllFileNoteForPerson' );
    $group->get('/getFile/{personID:[0-9]+}/[{path:.*}]', FileManagerController::class . ':getRealFile' );
    $group->post('/getPreview', FileManagerController::class . ':getPreview' );
    $group->post('/changeFolder', FileManagerController::class . ':changeFolder' );
    $group->post('/folderBack', FileManagerController::class . ':folderBack' );
    $group->post('/deleteOneFolder', FileManagerController::class . ':deleteOneFolder' );
    $group->post('/deleteOneFile', FileManagerController::class . ':deleteOneFile' );
    $group->post('/deleteFiles', FileManagerController::class . ':deleteFiles' );
    $group->post('/movefiles', FileManagerController::class . ':movefiles' );
    $group->post('/newFolder', FileManagerController::class . ':newFolder' );
    $group->post('/rename', FileManagerController::class . ':renameFile' );
    $group->post('/uploadFile/{personID:[0-9]+}', FileManagerController::class . ':uploadFile' );
    $group->post('/getRealLink', FileManagerController::class . ':getRealLink' );
    $group->post('/setpathtopublicfolder', FileManagerController::class . ':setpathtopublicfolder' );
