...
VALUES
  ...
  (24, 'bEmailSend', '', 'boolean', '', 'If you wish to be able to send emails from within EcclesiaCRM. This requires\reither an SMTP server address to send from or sendmail installed in PHP.', 'General', NULL),
  (999, 'bRegistered', '0', 'boolean', '0',
   'EcclesiaCRM has been registered.  The EcclesiaCRM team uses registration information to track usage.  This information is kept confidential and never released or sold.  If this field is true the registration option in the admin menu changes to update registration.', 'General', NULL),
