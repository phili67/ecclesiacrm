...
(65, 'sTimeZone', 'Europe/Lisbon'),
(100, 'sPhoneFormat', '999 999 999'),
(101, 'sPhoneFormatWithExt', '999 999 999 999'),
...
(112, 'sTimeFormat', '%H:%M'),
(113, 'sPhoneCountryCallingCode', '0351'),
...
(2, 'f', 2, 'Pai solitário', 'é um agregado familiar monoparental.', '',''),
(3, 'g', 3, 'Jovem', 'é motivado para trabalhar no trabalho dos jovens.', '','')
