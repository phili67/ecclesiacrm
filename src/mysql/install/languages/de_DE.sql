...
(112, 'sTimeFormat', '%H:%M'),
(113, 'sPhoneCountryCallingCode', '0049'),
...
INSERT INTO `list_lst` (`lst_ID`, `lst_OptionID`, `lst_OptionSequence`, `lst_Type`, `lst_OptionName`) VALUES
  (1, 1, 1, 'normal', 'Referent'),
  (1, 2, 2, 'normal', 'Mitglieder'),
  (1, 3, 3, 'normal', 'Regelmäßigen Abständen'),
  (1, 4, 4, 'normal', 'Besucher'),
  (1, 5, 5, 'normal', 'nicht teilnehmenden'),
  ...
  (3, 1, 1, 'normal', 'Ministerium'),
  (3, 2, 2, 'normal', 'Kirche Team'),
  (3, 3, 3, 'normal', 'Bibelstudien'),
...
INSERT INTO `property_pro` (`pro_ID`, `pro_Class`, `pro_prt_ID`, `pro_Name`, `pro_Description`, `pro_Prompt`, `pro_Comment`) VALUES
  ...
  (2, 'f', 2, 'Alleinerziehende', 'ist ein Haushalt mit nur einem Elternteil.', '', ''),
  (3, 'g', 3, 'Jung', 'motiviert ist, in der Jugendarbeit zu arbeiten.', '', '')
