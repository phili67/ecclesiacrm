...
abstract class NewsDashboard implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\PluginStore\\Map\\NewsDashboardTableMap';
     ...
     * @return $this|\PluginStore\NewsDashboard The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PluginStore\NewsDashboard
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PluginStore\NewsDashboard The current object, for fluid interface
     */
