...
class NoteDashboardTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PluginStore.Map.NoteDashboardTableMap';
     ...
     */
    const TABLE_NAME = 'NoteDashboard_nd';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\PluginStore\\NoteDashboard';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PluginStore.NoteDashboard';
     ...
     */
    const COL_ND_ID = 'NoteDashboard_nd.nd_id';

    /**
     * the column name for the nd_user_id field
     */
    const COL_ND_USER_ID = 'NoteDashboard_nd.nd_user_id';

    /**
     * the column name for the nd_note field
     */
    const COL_ND_NOTE = 'NoteDashboard_nd.nd_note';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'UserId', 'Note', ),
        self::TYPE_CAMELNAME     => array('id', 'userId', 'note', ),
        self::TYPE_COLNAME       => array(NoteDashboardTableMap::COL_ND_ID, NoteDashboardTableMap::COL_ND_USER_ID, NoteDashboardTableMap::COL_ND_NOTE, ),
        self::TYPE_FIELDNAME     => array('nd_id', 'nd_user_id', 'nd_note', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'UserId' => 1, 'Note' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'userId' => 1, 'note' => 2, ),
        self::TYPE_COLNAME       => array(NoteDashboardTableMap::COL_ND_ID => 0, NoteDashboardTableMap::COL_ND_USER_ID => 1, NoteDashboardTableMap::COL_ND_NOTE => 2, ),
        self::TYPE_FIELDNAME     => array('nd_id' => 0, 'nd_user_id' => 1, 'nd_note' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
