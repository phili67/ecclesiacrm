...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
    <div>
        <h3 class="h4 mb-1"><i class="fas fa-copy mr-2 text-success"></i><?= dgettext("messages-MailChimp", "Duplicate Emails") ?></h3>
        <p class="text-muted mb-0"><?= dgettext("messages-MailChimp", "Review duplicates before syncing audiences.") ?></p>
    </div>
...
<div class="card card-outline card-success shadow-sm">
    <div class="card-header">
        <h3 class="card-title mb-0"><i class="fas fa-table mr-1"></i><?= dgettext("messages-MailChimp", "Duplicate Emails") ?></h3>
    </div>
...
<script src="<?= $sRootPath ?>/Plugins/MailChimp/skin/js/DuplicateEmails.js"></script>
