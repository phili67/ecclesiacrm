 ...
 *
 * @method     ChildToDoListDashboardItem[]|Collection find(?ConnectionInterface $con = null) Return ChildToDoListDashboardItem objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildToDoListDashboardItem> find(?ConnectionInterface $con = null) Return ChildToDoListDashboardItem objects based on current ModelCriteria
 *
 * @method     ChildToDoListDashboardItem[]|Collection findById(int|array<int> $tdl_l_i_id) Return ChildToDoListDashboardItem objects filtered by the tdl_l_i_id column
 * @psalm-method Collection&\Traversable<ChildToDoListDashboardItem> findById(int|array<int> $tdl_l_i_id) Return ChildToDoListDashboardItem objects filtered by the tdl_l_i_id column
 * @method     ChildToDoListDashboardItem[]|Collection findByList(int|array<int> $tdl_l_i_list) Return ChildToDoListDashboardItem objects filtered by the tdl_l_i_list column
 * @psalm-method Collection&\Traversable<ChildToDoListDashboardItem> findByList(int|array<int> $tdl_l_i_list) Return ChildToDoListDashboardItem objects filtered by the tdl_l_i_list column
 * @method     ChildToDoListDashboardItem[]|Collection findByChecked(boolean|array<boolean> $tdl_l_i_checked) Return ChildToDoListDashboardItem objects filtered by the tdl_l_i_checked column
 * @psalm-method Collection&\Traversable<ChildToDoListDashboardItem> findByChecked(boolean|array<boolean> $tdl_l_i_checked) Return ChildToDoListDashboardItem objects filtered by the tdl_l_i_checked column
 * @method     ChildToDoListDashboardItem[]|Collection findByName(string|array<string> $tdl_l_i_name) Return ChildToDoListDashboardItem objects filtered by the tdl_l_i_name column
 * @psalm-method Collection&\Traversable<ChildToDoListDashboardItem> findByName(string|array<string> $tdl_l_i_name) Return ChildToDoListDashboardItem objects filtered by the tdl_l_i_name column
 * @method     ChildToDoListDashboardItem[]|Collection findByDateTime(string|array<string> $tdl_l_i_date_time) Return ChildToDoListDashboardItem objects filtered by the tdl_l_i_date_time column
 * @psalm-method Collection&\Traversable<ChildToDoListDashboardItem> findByDateTime(string|array<string> $tdl_l_i_date_time) Return ChildToDoListDashboardItem objects filtered by the tdl_l_i_date_time column
 * @method     ChildToDoListDashboardItem[]|Collection findByPlace(int|array<int> $tdl_l_i_place) Return ChildToDoListDashboardItem objects filtered by the tdl_l_i_place column
 * @psalm-method Collection&\Traversable<ChildToDoListDashboardItem> findByPlace(int|array<int> $tdl_l_i_place) Return ChildToDoListDashboardItem objects filtered by the tdl_l_i_place column
 *
...
abstract class ToDoListDashboardItemQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'pluginstore', $modelName = '\\PluginStore\\ToDoListDashboardItem', ?string $modelAlias = null)
    {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(ToDoListDashboardItemTableMap::COL_TDL_L_I_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(ToDoListDashboardItemTableMap::COL_TDL_L_I_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ToDoListDashboardItemTableMap::COL_TDL_L_I_ID, $id, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByList($list = null, ?string $comparison = null)
    {
        if (is_array($list)) {
            $useMinMax = false;
            if (isset($list['min'])) {
        ...
        $this->addUsingAlias(ToDoListDashboardItemTableMap::COL_TDL_L_I_LIST, $list, $comparison);
    ...
    public function filterByChecked($checked = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ToDoListDashboardItemTableMap::COL_TDL_L_I_CHECKED, $checked, $comparison);
     ...
     * $query->filterByName(['foo', 'bar']); // WHERE tdl_l_i_name IN ('foo', 'bar')
     * </code>
     *
    ...
    public function filterByName($name = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ToDoListDashboardItemTableMap::COL_TDL_L_I_NAME, $name, $comparison);
    ...
    public function filterByDateTime($dateTime = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ToDoListDashboardItemTableMap::COL_TDL_L_I_DATE_TIME, $dateTime, $comparison);
    ...
    public function filterByPlace($place = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ToDoListDashboardItemTableMap::COL_TDL_L_I_PLACE, $place, $comparison);
