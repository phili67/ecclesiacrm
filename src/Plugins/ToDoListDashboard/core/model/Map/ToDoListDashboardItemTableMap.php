...
class ToDoListDashboardItemTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PluginStore.Map.ToDoListDashboardItemTableMap';
     ...
     */
    const TABLE_NAME = 'tdl_l_item';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\PluginStore\\ToDoListDashboardItem';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PluginStore.ToDoListDashboardItem';
     ...
     */
    const COL_TDL_L_I_ID = 'tdl_l_item.tdl_l_i_id';

    /**
     * the column name for the tdl_l_i_list field
     */
    const COL_TDL_L_I_LIST = 'tdl_l_item.tdl_l_i_list';

    /**
     * the column name for the tdl_l_i_checked field
     */
    const COL_TDL_L_I_CHECKED = 'tdl_l_item.tdl_l_i_checked';

    /**
     * the column name for the tdl_l_i_name field
     */
    const COL_TDL_L_I_NAME = 'tdl_l_item.tdl_l_i_name';

    /**
     * the column name for the tdl_l_i_date_time field
     */
    const COL_TDL_L_I_DATE_TIME = 'tdl_l_item.tdl_l_i_date_time';

    /**
     * the column name for the tdl_l_i_place field
     */
    const COL_TDL_L_I_PLACE = 'tdl_l_item.tdl_l_i_place';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'List', 'Checked', 'Name', 'DateTime', 'Place', ),
        self::TYPE_CAMELNAME     => array('id', 'list', 'checked', 'name', 'dateTime', 'place', ),
        self::TYPE_COLNAME       => array(ToDoListDashboardItemTableMap::COL_TDL_L_I_ID, ToDoListDashboardItemTableMap::COL_TDL_L_I_LIST, ToDoListDashboardItemTableMap::COL_TDL_L_I_CHECKED, ToDoListDashboardItemTableMap::COL_TDL_L_I_NAME, ToDoListDashboardItemTableMap::COL_TDL_L_I_DATE_TIME, ToDoListDashboardItemTableMap::COL_TDL_L_I_PLACE, ),
        self::TYPE_FIELDNAME     => array('tdl_l_i_id', 'tdl_l_i_list', 'tdl_l_i_checked', 'tdl_l_i_name', 'tdl_l_i_date_time', 'tdl_l_i_place', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'List' => 1, 'Checked' => 2, 'Name' => 3, 'DateTime' => 4, 'Place' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'list' => 1, 'checked' => 2, 'name' => 3, 'dateTime' => 4, 'place' => 5, ),
        self::TYPE_COLNAME       => array(ToDoListDashboardItemTableMap::COL_TDL_L_I_ID => 0, ToDoListDashboardItemTableMap::COL_TDL_L_I_LIST => 1, ToDoListDashboardItemTableMap::COL_TDL_L_I_CHECKED => 2, ToDoListDashboardItemTableMap::COL_TDL_L_I_NAME => 3, ToDoListDashboardItemTableMap::COL_TDL_L_I_DATE_TIME => 4, ToDoListDashboardItemTableMap::COL_TDL_L_I_PLACE => 5, ),
        self::TYPE_FIELDNAME     => array('tdl_l_i_id' => 0, 'tdl_l_i_list' => 1, 'tdl_l_i_checked' => 2, 'tdl_l_i_name' => 3, 'tdl_l_i_date_time' => 4, 'tdl_l_i_place' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
