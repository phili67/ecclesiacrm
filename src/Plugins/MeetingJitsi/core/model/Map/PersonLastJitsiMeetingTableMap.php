...
class PersonLastJitsiMeetingTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PluginStore.Map.PersonLastJitsiMeetingTableMap';
     ...
     */
    const TABLE_NAME = 'personlastjitsimeeting_plm';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\PluginStore\\PersonLastJitsiMeeting';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PluginStore.PersonLastJitsiMeeting';
     ...
     */
    const COL_JM_PLM_ID = 'personlastjitsimeeting_plm.jm_plm_ID';

    /**
     * the column name for the jm_plm_person_id field
     */
    const COL_JM_PLM_PERSON_ID = 'personlastjitsimeeting_plm.jm_plm_person_id';

    /**
     * the column name for the jm_plm_personmeeting_pm_id field
     */
    const COL_JM_PLM_PERSONMEETING_PM_ID = 'personlastjitsimeeting_plm.jm_plm_personmeeting_pm_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'PersonId', 'PersonMeetingId', ),
        self::TYPE_CAMELNAME     => array('id', 'personId', 'personMeetingId', ),
        self::TYPE_COLNAME       => array(PersonLastJitsiMeetingTableMap::COL_JM_PLM_ID, PersonLastJitsiMeetingTableMap::COL_JM_PLM_PERSON_ID, PersonLastJitsiMeetingTableMap::COL_JM_PLM_PERSONMEETING_PM_ID, ),
        self::TYPE_FIELDNAME     => array('jm_plm_ID', 'jm_plm_person_id', 'jm_plm_personmeeting_pm_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'PersonId' => 1, 'PersonMeetingId' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'personId' => 1, 'personMeetingId' => 2, ),
        self::TYPE_COLNAME       => array(PersonLastJitsiMeetingTableMap::COL_JM_PLM_ID => 0, PersonLastJitsiMeetingTableMap::COL_JM_PLM_PERSON_ID => 1, PersonLastJitsiMeetingTableMap::COL_JM_PLM_PERSONMEETING_PM_ID => 2, ),
        self::TYPE_FIELDNAME     => array('jm_plm_ID' => 0, 'jm_plm_person_id' => 1, 'jm_plm_personmeeting_pm_id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // PersonLastJitsiMeetingTableMap
