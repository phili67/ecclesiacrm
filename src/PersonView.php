        ...
        <div class="card card-primary">
            ...
            ?>
                ...
                <ul class="fa-ul">
                    ...
                    if ($sCellPhone) {
                        ?>
                        <li><strong><i class="fa-li fa fa-mobile-phone"></i><?= _('Mobile Phone') ?>:</strong> <span><a
                                    href="tel:<?= $sCellPhoneUnformatted ?>"><?= $sCellPhone ?></a></span></li>
                        <li><strong><i class="fa-li fa fa-mobile-phone"></i><?= _('Text Message') ?>:</strong> <span><a
                    ...
                    if ($sEmail != '') {
                        ...
                        if ($isMailChimpActive) {
                            ?>
                            <li><strong><i class="fa-li fa fa-send"></i>MailChimp:</strong> <span id="mailChimpUserNormal"></span>
                            </li>
                            <?php
                        }
                    }
                    ...
                    if ($person->getWorkEmail() != '') {
                        ?>
                        <li><strong><i class="fa-li fa fa-envelope"></i><?= _('Work/Other Email') ?>:</strong> <span><a
                    ...
                    if ($person->getFacebookID() > 0) {
                        ?>
                        <li><strong><i class="fa-li fa fa-facebook-official"></i><?= _('Facebook') ?>:</strong> <span><a
            ...
            <div class="card-body">
                ...
                if (SessionUser::getUser()->isDeleteRecordsEnabled() && $iPersonID != 1) {// the super user can't be deleted
                    ...
                    if (count($person->getOtherFamilyMembers()) > 0 || is_null($person->getFamily())) {
                        ?>
                        <a class="btn btn-app bg-maroon delete-person" data-person_name="<?= $person->getFullName() ?>"
                                                            ...
                                                            <code>
                                                                ...
                                                                <div class="btn-group">
                                                                    ...
                                                                    <ul class="dropdown-menu" role="menu">
                                                                        <li class="dropdown-item"><a class="changeRole"
                                                                ...
                                                                <div class="btn-group">
                                                                    <button
                                                                        ...
                                                                        type="button" class="btn btn-danger groupRemove"
