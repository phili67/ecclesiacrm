...
function add_ckeditor_buttons(editor) {
    ...
    var newpage = '/skin/js/ckeditor/ckeditorExtraPlugin/icons/hidpi/newpage.png';
    var saveAsWord = '/skin/js/ckeditor/ckeditorExtraPlugin/icons/hidpi/saveWord.png';
    var saveTemplate = '/skin/js/ckeditor/ckeditorExtraPlugin/icons/hidpi/saveTemplate.png';
    var template = '/skin/js/ckeditor/ckeditorExtraPlugin/icons/hidpi/templates.png';
    if (window.CRM.bDarkMode) {
        newpage = '/skin/js/ckeditor/ckeditorExtraPlugin/icons/hidpi/newpage_black.png';
        saveAsWord = '/skin/js/ckeditor/ckeditorExtraPlugin/icons/hidpi/saveWord_black.png';
        saveTemplate = '/skin/js/ckeditor/ckeditorExtraPlugin/icons/hidpi/saveTemplate_black.png';
        template = '/skin/js/ckeditor/ckeditorExtraPlugin/icons/hidpi/templates_black.png';
    }
    ...
    editor.ui.addButton('SaveTemplateButton', { // add new button and bind our command to the template group
        ...
        toolbar: 'template',
        icon: window.CRM.root + saveTemplate
    });
    ...
    editor.ui.addButton('SaveAsWordFileButton', { // add new button and bind our command to the export group
        ...
        toolbar: 'export',
        icon: window.CRM.root + saveAsWord
    });
