$("document").ready(function() {
    ...
    function BootboxContentAttendees (start) {
        ...
        var frm_str = '<b>' +
            ...
            + '                 </div>'
            + '                 <input class=" form-control  form-control-sm date-picker form-control-sm" type="text" id="dateAttendees" name="dateAttendees"  value="' + dateAttendees + '" '
            ...
            + '             </div>'
            + '             <div class="col-md-6">'
            + '                 <select class="bootbox-input bootbox-input-select form-control form-control-sm" id="chosenType">'
            + '             </div>'
            + '             <div class="col-md-3">'
            + '             </div>'
            + '        </div>'
