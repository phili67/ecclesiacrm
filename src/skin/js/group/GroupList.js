    ...
    columns: [
      {
        ...
        render: function (data, type, full, meta) {
            return '<a href="' + window.CRM.root + '/GroupView.php?GroupID=' + full.Id + '"><span class="fa-stack"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-search-plus fa-stack-1x fa-inverse"></i></span></a><a href="' + window.CRM.root + '/GroupEditor.php?GroupID=' + full.Id + '"><span class="fa-stack"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-pencil fa-stack-1x fa-inverse"></i></span></a>' + data;
        }
      },
      {
        width: 'auto',
