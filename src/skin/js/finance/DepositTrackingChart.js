$(function() {
    ...
    window.CRM.renderDepositTrackingChart = function() {
        if (window.CRM._depositChartRendered) {
            return;
        }
        ...
        var canvas = $("#deposit-lineGraph").get(0);
        ...
        var lineData = {
            ...
            datasets: [
                {
                    label: i18next.t("Tracking", {
                        ns: 'FinanceDashboard',
                        defaultValue: i18next.t("Tracking")
                    }),
                    data: [],
                    borderColor: '#ffffff',
        ...
        window.CRM.depositLineChart = new Chart(lineChartCanvas, {
            type: 'line',
            data: lineData,
        ...
        window.CRM._depositChartRendered = true;
    };

    window.CRM.renderDepositTrackingChart();
});
