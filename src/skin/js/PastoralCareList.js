  ...
  /* IMPORTANT : be careful
    ...
    function BootboxContentPastoralCareTypeList(){    
      var frm_str = '<div class="box-body">'
        +'<div class="row">'
        +'  <div class="col-lg-2">'
        +'    <label for="depositComment">'+i18next.t("Visible")+'</label>'
        +'    <input id="visibleCheckbox" type="checkbox" name="visible" id="visible" checked="checked">'
        +'  </div>'
        +'  <div class="col-lg-1">'
        +'    <label for="depositDate">'+i18next.t("Title")+'</label>'
        +'  </div>'
        +'  <div class="col-lg-9">'
        +'    <input class="form-control input-sm" name="Title" id="Title" style="width:100%">'
        +'  </div>'
        +'</div>'
        +'<div class="row">'
        +'  <div class="col-lg-2">'
