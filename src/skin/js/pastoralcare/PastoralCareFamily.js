         ...
         callback: function() {
            ...
            if (id == -1) {
              ...
              window.CRM.APIRequest({
                  ...
                  data: JSON.stringify({"ID":id,"typeID":typeID,"familyID":currentFamilyID,"currentPastorId":currentPastorId,"typeDesc":typeDesc,"visibilityStatus":visibilityStatus,"noteText":NoteText})
              }).done(function(data) {
                 location.reload();
                 return true;
              })
