$(document).ready(function () {
  ...
  $(document).on("click","#createDocument", function(){
    ...
    var modal = createDocumentEditorWindow();
  ...
  function BootboxContent(sTitleText, sDocType, sText){  
    ...
    function createDocumentEditorWindow ()
    {
           ...
           callback: function() {
              ...
              if (DocumentTitle != "") {
                ...
                window.CRM.APIRequest({
                  ...
                  data: JSON.stringify({"personID" : window.CRM.currentPersonID, "famID" : 0, "title" : DocumentTitle, "type" : Type,"text" : htmlBody, "bPrivate" : Private})
                }).done(function(data) {
                  if (data.success) {
                    location.reload();
                  }
