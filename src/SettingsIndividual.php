    ...
    <div class="col-md-6">
        <div class="card card-primary">
            ...
            <div class="card-body" id="TwoFAEnrollmentSteps">
                ...
                <p>Enrolling your EcclesiaCRM user account in Two Factor Authentication provides an
                    EcclesiaCRM layer of defense against bad actors trying to access your account.</p>
                <p>EcclesiaCRM Two factor supports any TOTP authenticator app</p>
                <hr>
                <div class="row">
                <div class="col-md-4">

                    <p><i class="fa fa-id-card-o"></i> When you sign in to EcclesiaCRM, you'll still enter your username and password like
                        normal</p></div>
                <div class="col-md-4">

                    <p><i class="fa fa-key fa-10x"></i> However, you'll also need to supply a one-time code from your authenticator device to
                        complete your login</p></div>
                <div class="col-md-4">

                    <p><i class="fa fa-check-square-o"></i> After successfully entering both your credentials, and the one-time code, you'll be
                        logged in as normal</p></div>
                </div>
                <div class="clearfix"></div>
                <div class="callout callout-warning"><p>To prevent being locked out of your EcclesiaCRM account,
                        please ensure you're ready to complete two factor enrollment before clicking begin</p>
                </div>
                <ul>
                    <li>Beginning enrollment will invalidate any previously enrolled 2 factor devices and
                        recovery codes.
                    </li>
                    <li>When you click next, you'll be prompted to scan a QR code to enroll your authenticator
                        app.
                    </li>
                    <li>To confirm enrollment, you'll need to enter the code generated by your authenticator
                        app
                    </li>
                    <li>After confirming app enrollment, single-use recovery codes will be generated and
                        displayed.
                        <ul>
                            <li>Recovery codes can be used instead of a code generated from your authenticator
                                app.
                            </li>
                            <li>Store these in a secure location</li>
                        </ul>
                    </li>
                </ul>
                ...
                <div class="clearfix"></div>
                <button class="btn btn-success Twofa-activation">Begin Two Factor Authentication Enrollment</button>
            </div>
        </div>
    </div>
</div>
