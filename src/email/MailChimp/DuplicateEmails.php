...
<div class="box-header  with-border">
  <h3 class="box-title"><?= _("Duplicate Emails")?></h3><div style="float:right"><a href="https://mailchimp.com/en/"><img src="<?= SystemURLs::getRootPath() ?>/Images/Mailchimp_Logo-Horizontal_Black.png" height=25/></a></div>
</div>
