...
class Person2group2roleP2g2rTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.Person2group2roleP2g2rTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\Person2group2roleP2g2r';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.Person2group2roleP2g2r';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\Person2group2roleP2g2r');
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \EcclesiaCRM\Person2group2roleP2g2r $obj A \EcclesiaCRM\Person2group2roleP2g2r object.
     ...
     *
     * @param mixed $value A \EcclesiaCRM\Person2group2roleP2g2r object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \EcclesiaCRM\Person2group2roleP2g2r) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \EcclesiaCRM\Person2group2roleP2g2r object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\Person2group2roleP2g2r) { // it's a model object
