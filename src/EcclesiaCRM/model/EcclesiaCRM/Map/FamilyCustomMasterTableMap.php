...
class FamilyCustomMasterTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_FIELDNAME     => array('fam_custom_Order', 'fam_custom_Field', 'fam_custom_Name', 'fam_custom_Special', 'fam_custom_Side', 'fam_custom_FieldSec', 'type_ID', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(FamilyCustomMasterTableMap::COL_FAM_CUSTOM_ORDER => 0, FamilyCustomMasterTableMap::COL_FAM_CUSTOM_FIELD => 1, FamilyCustomMasterTableMap::COL_FAM_CUSTOM_NAME => 2, FamilyCustomMasterTableMap::COL_FAM_CUSTOM_SPECIAL => 3, FamilyCustomMasterTableMap::COL_FAM_CUSTOM_SIDE => 4, FamilyCustomMasterTableMap::COL_FAM_CUSTOM_FIELDSEC => 5, FamilyCustomMasterTableMap::COL_TYPE_ID => 6, ),
        self::TYPE_FIELDNAME     => array('fam_custom_Order' => 0, 'fam_custom_Field' => 1, 'fam_custom_Name' => 2, 'fam_custom_Special' => 3, 'fam_custom_Side' => 4, 'fam_custom_FieldSec' => 5, 'type_ID' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
