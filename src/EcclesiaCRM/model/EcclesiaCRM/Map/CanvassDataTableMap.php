...
class CanvassDataTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.CanvassDataTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\CanvassData';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.CanvassData';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\CanvassData');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\CanvassData) { // it's a model object
