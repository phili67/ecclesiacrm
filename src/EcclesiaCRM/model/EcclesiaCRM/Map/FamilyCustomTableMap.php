...
class FamilyCustomTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.FamilyCustomTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\FamilyCustom';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.FamilyCustom';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\FamilyCustom');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\FamilyCustom) { // it's a model object
