...
use EcclesiaCRM\QueryParameters;
use EcclesiaCRM\QueryParametersQuery;
...
class QueryParametersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.QueryParametersTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\QueryParameters';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.QueryParameters';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\QueryParameters');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\QueryParameters) { // it's a model object
