...
class DonatedItemTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.DonatedItemTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\DonatedItem';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.DonatedItem';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\DonatedItem');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\DonatedItem) { // it's a model object
