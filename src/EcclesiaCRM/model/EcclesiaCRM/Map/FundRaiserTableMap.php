...
class FundRaiserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.FundRaiserTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\FundRaiser';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.FundRaiser';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\FundRaiser');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\FundRaiser) { // it's a model object
