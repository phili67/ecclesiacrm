...
use EcclesiaCRM\EmailRecipientPending;
use EcclesiaCRM\EmailRecipientPendingQuery;
...
class EmailRecipientPendingTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.EmailRecipientPendingTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\EmailRecipientPending';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.EmailRecipientPending';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\EmailRecipientPending');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\EmailRecipientPending) { // it's a model object
