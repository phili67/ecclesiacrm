...
class MenuConfigTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.MenuConfigTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\MenuConfig';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.MenuConfig';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\MenuConfig');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\MenuConfig) { // it's a model object
