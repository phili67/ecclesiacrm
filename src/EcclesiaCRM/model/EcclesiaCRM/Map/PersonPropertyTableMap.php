...
use EcclesiaCRM\PersonProperty;
...
class PersonPropertyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.PersonPropertyTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\PersonProperty';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.PersonProperty';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\PersonProperty');
    ...
    {
        $this->addRelation('Property', '\\EcclesiaCRM\\Property', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':r2p_pro_ID',
    1 => ':pro_ID',
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \EcclesiaCRM\PersonProperty $obj A \EcclesiaCRM\PersonProperty object.
     ...
     *
     * @param mixed $value A \EcclesiaCRM\PersonProperty object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \EcclesiaCRM\PersonProperty) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \EcclesiaCRM\PersonProperty object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\PersonProperty) { // it's a model object
