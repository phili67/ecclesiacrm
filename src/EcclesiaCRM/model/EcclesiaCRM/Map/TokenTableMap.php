...
class TokenTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.TokenTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\Token';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.Token';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\Token');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\Token) { // it's a model object
