...
class PropertyTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.PropertyTypeTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\PropertyType';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.PropertyType';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\PropertyType');
    ...
    {
        $this->addRelation('Property', '\\EcclesiaCRM\\Property', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':pro_prt_ID',
    1 => ':prt_ID',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\PropertyType) { // it's a model object
