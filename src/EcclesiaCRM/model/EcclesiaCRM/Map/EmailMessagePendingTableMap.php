...
use EcclesiaCRM\EmailMessagePending;
use EcclesiaCRM\EmailMessagePendingQuery;
...
class EmailMessagePendingTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.EmailMessagePendingTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\EmailMessagePending';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.EmailMessagePending';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\EmailMessagePending');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\EmailMessagePending) { // it's a model object
