...
class ConfigTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.ConfigTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\Config';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.Config';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ConfigTableMap::COL_CFG_ID, ConfigTableMap::COL_CFG_NAME, ConfigTableMap::COL_CFG_VALUE, ),
        self::TYPE_FIELDNAME     => array('cfg_id', 'cfg_name', 'cfg_value', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ConfigTableMap::COL_CFG_ID => 0, ConfigTableMap::COL_CFG_NAME => 1, ConfigTableMap::COL_CFG_VALUE => 2, ),
        self::TYPE_FIELDNAME     => array('cfg_id' => 0, 'cfg_name' => 1, 'cfg_value' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\Config');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\Config) { // it's a model object
