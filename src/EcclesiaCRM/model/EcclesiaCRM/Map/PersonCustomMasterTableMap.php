...
class PersonCustomMasterTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Order', 'Id', 'Name', 'Special', 'Side', 'CustomFieldSec', 'TypeId', ),
        self::TYPE_CAMELNAME     => array('order', 'id', 'name', 'special', 'side', 'customFieldSec', 'typeId', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Order' => 0, 'Id' => 1, 'Name' => 2, 'Special' => 3, 'Side' => 4, 'CustomFieldSec' => 5, 'TypeId' => 6, ),
        self::TYPE_CAMELNAME     => array('order' => 0, 'id' => 1, 'name' => 2, 'special' => 3, 'side' => 4, 'customFieldSec' => 5, 'typeId' => 6, ),
    ...
    public function initialize()
    {
        ...
        $this->addColumn('custom_Side', 'Side', 'CHAR', true, null, 'left');
