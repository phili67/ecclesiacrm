...
use EcclesiaCRM\WhyCame;
use EcclesiaCRM\WhyCameQuery;
...
class WhyCameTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EcclesiaCRM.Map.WhyCameTableMap';
     ...
     */
    const OM_CLASS = '\\EcclesiaCRM\\WhyCame';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EcclesiaCRM.WhyCame';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EcclesiaCRM\\WhyCame');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EcclesiaCRM\WhyCame) { // it's a model object
