...
abstract class ListOption implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\EcclesiaCRM\\Map\\ListOptionTableMap';
    ...
    /**
     * Initializes internal state of EcclesiaCRM\Base\ListOption object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\EcclesiaCRM\ListOption The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\EcclesiaCRM\\ListOption'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\EcclesiaCRM\ListOption
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\EcclesiaCRM\ListOption The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EcclesiaCRM\ListOption (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EcclesiaCRM\ListOption Clone of current object.
     * @throws PropelException
     */
    ...
    public function initGroups($overrideExisting = true)
    {
        ...
        $this->collGroups->setModel('\EcclesiaCRM\Group');
    }
