...
use \Exception;
use \PDO;
use EcclesiaCRM\QueryParametersQuery as ChildQueryParametersQuery;
use EcclesiaCRM\Map\QueryParametersTableMap;
...
abstract class QueryParameters implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\EcclesiaCRM\\Map\\QueryParametersTableMap';
    ...
    /**
     * Initializes internal state of EcclesiaCRM\Base\QueryParameters object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\EcclesiaCRM\QueryParameters The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\EcclesiaCRM\\QueryParameters'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\EcclesiaCRM\QueryParameters
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\EcclesiaCRM\QueryParameters The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EcclesiaCRM\QueryParameters (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EcclesiaCRM\QueryParameters Clone of current object.
     * @throws PropelException
     */
