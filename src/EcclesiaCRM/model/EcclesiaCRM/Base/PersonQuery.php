 ...
 *
 * @method     ChildPersonQuery leftJoinPersonProperty($relationAlias = null) Adds a LEFT JOIN clause to the query using the PersonProperty relation
 * @method     ChildPersonQuery rightJoinPersonProperty($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PersonProperty relation
 * @method     ChildPersonQuery innerJoinPersonProperty($relationAlias = null) Adds a INNER JOIN clause to the query using the PersonProperty relation
 *
 * @method     ChildPersonQuery joinWithPersonProperty($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the PersonProperty relation
 *
 * @method     ChildPersonQuery leftJoinWithPersonProperty() Adds a LEFT JOIN clause and with to the query using the PersonProperty relation
 * @method     ChildPersonQuery rightJoinWithPersonProperty() Adds a RIGHT JOIN clause and with to the query using the PersonProperty relation
 * @method     ChildPersonQuery innerJoinWithPersonProperty() Adds a INNER JOIN clause and with to the query using the PersonProperty relation
 *
 * @method     \EcclesiaCRM\FamilyQuery|\EcclesiaCRM\WhyCameQuery|\EcclesiaCRM\PersonCustomQuery|\EcclesiaCRM\NoteQuery|\EcclesiaCRM\Person2group2roleP2g2rQuery|\EcclesiaCRM\EventAttendQuery|\EcclesiaCRM\UserQuery|\EcclesiaCRM\PersonPropertyQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PersonQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related \EcclesiaCRM\WhyCame object
     *
     * @param \EcclesiaCRM\WhyCame|ObjectCollection $whyCame the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPersonQuery The current query, for fluid interface
     */
    ...
    {
        if ($whyCame instanceof \EcclesiaCRM\WhyCame) {
            return $this
            ...
            throw new PropelException('filterByWhyCame() only accepts arguments of type \EcclesiaCRM\WhyCame or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\WhyCameQuery A secondary query class using the current class as primary query
     */
    public function useWhyCameQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinWhyCame($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'WhyCame', '\EcclesiaCRM\WhyCameQuery');
    }
    ...
    /**
     * Filter the query by a related \EcclesiaCRM\PersonProperty object
     *
     * @param \EcclesiaCRM\PersonProperty|ObjectCollection $personProperty the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPersonQuery The current query, for fluid interface
     */
    ...
    {
        if ($personProperty instanceof \EcclesiaCRM\PersonProperty) {
            return $this
                ->addUsingAlias(PersonTableMap::COL_PER_ID, $personProperty->getPersonId(), $comparison);
            ...
            throw new PropelException('filterByPersonProperty() only accepts arguments of type \EcclesiaCRM\PersonProperty or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\PersonPropertyQuery A secondary query class using the current class as primary query
     */
    public function usePersonPropertyQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'PersonProperty', '\EcclesiaCRM\PersonPropertyQuery');
    }
     ...
     *
     * @param Property $property the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPersonQuery The current query, for fluid interface
     */
    public function filterByProperty($property, $comparison = Criteria::EQUAL)
    {
        return $this
            ->usePersonPropertyQuery()
            ->filterByProperty($property, $comparison)
            ->endUse();
    }
