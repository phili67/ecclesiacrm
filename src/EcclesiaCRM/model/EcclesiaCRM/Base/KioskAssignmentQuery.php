 ...
 *
 * @method     \EcclesiaCRM\KioskDeviceQuery|\EcclesiaCRM\EventQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class KioskAssignmentQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EcclesiaCRM\Base\KioskAssignmentQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EcclesiaCRM\\KioskAssignment', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \EcclesiaCRM\KioskDevice object
     *
     * @param \EcclesiaCRM\KioskDevice|ObjectCollection $kioskDevice The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($kioskDevice instanceof \EcclesiaCRM\KioskDevice) {
            return $this
            ...
            throw new PropelException('filterByKioskDevice() only accepts arguments of type \EcclesiaCRM\KioskDevice or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EcclesiaCRM\KioskDeviceQuery A secondary query class using the current class as primary query
     */
    public function useKioskDeviceQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinKioskDevice($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'KioskDevice', '\EcclesiaCRM\KioskDeviceQuery');
    }
