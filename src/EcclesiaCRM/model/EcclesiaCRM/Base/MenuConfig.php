...
use \Exception;
use \PDO;
use EcclesiaCRM\MenuConfigQuery as ChildMenuConfigQuery;
use EcclesiaCRM\Map\MenuConfigTableMap;
...
abstract class MenuConfig implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\EcclesiaCRM\\Map\\MenuConfigTableMap';
    ...
    /**
     * Initializes internal state of EcclesiaCRM\Base\MenuConfig object.
     */
     ...
     * @return $this|\EcclesiaCRM\MenuConfig The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\EcclesiaCRM\\MenuConfig'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\EcclesiaCRM\MenuConfig
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\EcclesiaCRM\MenuConfig The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EcclesiaCRM\MenuConfig (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EcclesiaCRM\MenuConfig Clone of current object.
     * @throws PropelException
     */
