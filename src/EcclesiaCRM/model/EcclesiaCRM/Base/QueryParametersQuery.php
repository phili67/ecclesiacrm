...
use \Exception;
use \PDO;
use EcclesiaCRM\QueryParameters as ChildQueryParameters;
...
abstract class QueryParametersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EcclesiaCRM\Base\QueryParametersQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EcclesiaCRM\\QueryParameters', $modelAlias = null)
    {
