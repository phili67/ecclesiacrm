...
abstract class Person2group2roleP2g2r implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\EcclesiaCRM\\Map\\Person2group2roleP2g2rTableMap';
    ...
    /**
     * Initializes internal state of EcclesiaCRM\Base\Person2group2roleP2g2r object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\EcclesiaCRM\Person2group2roleP2g2r The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\EcclesiaCRM\\Person2group2roleP2g2r'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\EcclesiaCRM\Person2group2roleP2g2r
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\EcclesiaCRM\Person2group2roleP2g2r The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EcclesiaCRM\Person2group2roleP2g2r (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EcclesiaCRM\Person2group2roleP2g2r Clone of current object.
     * @throws PropelException
     */
