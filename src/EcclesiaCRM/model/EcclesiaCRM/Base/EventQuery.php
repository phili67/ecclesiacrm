 ...
 *
 * @method     \EcclesiaCRM\GroupQuery|\EcclesiaCRM\EventAttendQuery|\EcclesiaCRM\KioskAssignmentQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class EventQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT event_id, event_type, event_title, event_desc, event_text, event_start, event_end, inactive, event_typename, event_grpid FROM events_event WHERE event_id = :p0';
        try {
