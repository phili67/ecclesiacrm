...
use \Exception;
use \PDO;
use EcclesiaCRM\EmailMessagePendingQuery as ChildEmailMessagePendingQuery;
use EcclesiaCRM\Map\EmailMessagePendingTableMap;
...
abstract class EmailMessagePending implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\EcclesiaCRM\\Map\\EmailMessagePendingTableMap';
    ...
    /**
     * Initializes internal state of EcclesiaCRM\Base\EmailMessagePending object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\EcclesiaCRM\EmailMessagePending The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\EcclesiaCRM\\EmailMessagePending'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\EcclesiaCRM\EmailMessagePending
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\EcclesiaCRM\EmailMessagePending The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EcclesiaCRM\EmailMessagePending (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EcclesiaCRM\EmailMessagePending Clone of current object.
     * @throws PropelException
     */
