 ...
 *
 * @method     \EcclesiaCRM\PersonQuery|\EcclesiaCRM\GroupQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class Person2group2roleP2g2rQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EcclesiaCRM\Base\Person2group2roleP2g2rQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EcclesiaCRM\\Person2group2roleP2g2r', $modelAlias = null)
    {
