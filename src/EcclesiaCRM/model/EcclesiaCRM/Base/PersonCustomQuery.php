 ...
 *
 * @method     ChildPersonCustomQuery leftJoinPerson($relationAlias = null) Adds a LEFT JOIN clause to the query using the Person relation
 * @method     ChildPersonCustomQuery rightJoinPerson($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Person relation
 * @method     ChildPersonCustomQuery innerJoinPerson($relationAlias = null) Adds a INNER JOIN clause to the query using the Person relation
 *
 * @method     ChildPersonCustomQuery joinWithPerson($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Person relation
 *
 * @method     ChildPersonCustomQuery leftJoinWithPerson() Adds a LEFT JOIN clause and with to the query using the Person relation
 * @method     ChildPersonCustomQuery rightJoinWithPerson() Adds a RIGHT JOIN clause and with to the query using the Person relation
 * @method     ChildPersonCustomQuery innerJoinWithPerson() Adds a INNER JOIN clause and with to the query using the Person relation
 *
...
abstract class PersonCustomQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EcclesiaCRM\Base\PersonCustomQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EcclesiaCRM\\PersonCustom', $modelAlias = null)
    {
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildPersonCustomQuery The current query, for fluid interface
     */
    public function filterByPerson($person, $comparison = null)
    {
        if ($person instanceof \EcclesiaCRM\Person) {
            return $this
                ->addUsingAlias(PersonCustomTableMap::COL_PER_ID, $person->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PersonCustomTableMap::COL_PER_ID, $person->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
