 ...
 *
 * @method     \EcclesiaCRM\EventQuery|\EcclesiaCRM\PersonQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildEventAttend findOneByAttendId(int $attend_id) Return the first ChildEventAttend filtered by the attend_id column
...
abstract class EventAttendQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EcclesiaCRM\Base\EventAttendQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EcclesiaCRM\\EventAttend', $modelAlias = null)
    {
