...
class PDF_Attendance extends ChurchInfoReportTCPDF
{
/////////////////////////////////////////////////////////////////////////////
//
...
//
        ...
        for ($p = 0; $p < $nPages; $p++) {
            ...
            foreach ($labels as $key => $value) {
                switch ($key) {
                    ...
                    case 'stats':
                        ...
                        $this->TextWithDirection($nameX + 57 - 3, $y - 5.5, $value, 'U');
                        $this->SetFont('Times', '', $fontTitleNormal);
                        break;
                    case 'groupName':
                        break;
            ...
            foreach ($sizeArray as $c) {
                $this->TextWithDirection($nameX + 64 + $datePlace - 3, $y + 9, $c . "/" . $real_count, 'U');
                $datePlace += 7;
            }
            $this->SetFont('Times', '', $fontTitleNormal);
