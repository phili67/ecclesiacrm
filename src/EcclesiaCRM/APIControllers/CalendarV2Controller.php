    ...
    public function calendarInfo (ServerRequest $request, Response $response, array $args): Response {
        ...
        if ( isset ($params->calIDs) && isset ($params->type) ) {
            ...
            if (SessionUser::getUser()->isAdmin()) {
                $message .= "<p><label>"._("You've to activate the \"bEnableExternalCalendarAPI\" setting in")." <a href=\"".$root."v2/systemsettings/Integration\">"._("General Settings/Integration")."</a>.";
            }
