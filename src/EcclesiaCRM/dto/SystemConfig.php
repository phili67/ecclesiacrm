...
class SystemConfig
{
    ...
    private static function buildConfigs()
  {
    return array(
        ...
        "iLittleMapZoom" => new ConfigItem(10002, "iLittleMapZoom", "number", "15", gettext("Google Litle Maps Zoom")),
  ...
  private static function buildCategories()
  {
    return array (
      ...
      gettext('Map Settings')  => ["sMapProvider","sNominatimLink","sGoogleMapKey","sBingMapKey","sGMapIcons", "iMapZoom","iLittleMapZoom","sISTusername","sISTpassword"],
