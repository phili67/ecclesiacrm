...
class SystemConfig
{
    ...
    private static function buildConfigs()
    {
        return array(
            ...
            "iMapZoom" => new ConfigItem(10001, "iMapZoom", "number", "12", _("Google/OpenStreetMap")),
            "iLittleMapZoom" => new ConfigItem(10002, "iLittleMapZoom", "number", "15", _("Google/OpenStreetMap")),
            ...
            "sMapProvider" => new ConfigItem(56, "sMapProvider", "choice", "OpenStreetMap", _("Select GeoCoder Provider"), "https://github.com/geocoder-php/Geocoder/blob/3.x/README.md#address-based-providers", '{"Choices":["OpenStreetMap", "GoogleMaps"]}'),
            ...
            "sPhoneCountryCallingCode" => new ConfigItem(113, "sPhoneCountryCallingCode", "text", "0001",_("Four digits : https://en.wikipedia.org/wiki/List_of_country_calling_codes")),
            ...
            "sTaxReport3" => new ConfigItem(1013, "sTaxReport3", "text", "If you have any questions or corrections to make to this report, please contact the entity at the above number during business hours, 9am to 4pm, M-F.", _("Verbage for bottom line of tax report.")),
            ...
            "sConfirm1" => new ConfigItem(1019, "sConfirm1", "text", "This letter shows the information we have in our database with respect to your family.  Please review, mark-up as necessary, and return this form to the entity office.", _("Verbage for the database information confirmation and correction report")),
            "sConfirm2" => new ConfigItem(1020, "sConfirm2", "text", "Thank you very much for helping us to update this information.  If you want on-line access to the entity database please provide your email address and a desired password and we will send instructions.", _("Verbage for the database information confirmation and correction report")),
            ...
            "sConfirm4" => new ConfigItem(1022, "sConfirm4", "text", "[  ] I no longer want to be associated with the entity (check here to be removed from our records).", _("Verbage for the database information confirmation and correction report")),
            ...
            "sDirectoryDisclaimer1" => new ConfigItem(1028, "sDirectoryDisclaimer1", "text", "Every effort was made to insure the accuracy of this directory.  If there are any errors or omissions, please contact the entity office.\n\nThis directory is for the use of the people of", _("Verbage for the directory report")),
            ...
            "sCloudURL" => new ConfigItem(2003, "sCloudURL", "text", "http://demo.ecclesiacrm.com/", _("CRM Cloud Access URL")),
            ...
            "bHSTSEnable" => new ConfigItem(20142, "bHSTSEnable", "boolean", "0", _("Require that this CRM Database is accessed over HTTPS")),
            ...
            "sUnsubscribeEnd" => new ConfigItem(2053, "sUnsubscribeEnd", "text", "in the future, please contact the entity admins", _("in the future, please contact the entity admins")),
            ...
            "bMailServiceWithAddressPhone" => new ConfigItem(2080, "bMailServiceWithAddressPhone", "boolean", "0", _("Add Address, Phone.")),
            ...
            "bMailServiceContentsExternalCssFont" => new ConfigItem(2091, "bMailServiceContentsExternalCssFont", "textarea", "", _("Link to a style sheet for a particular font. This is useful for the font menu of ckeditor : https://fonts.googleapis.com/css?family=Abril+Fatface:400,400i,700,700i,900,900i|Roboto:400,400i,700,700i,900,900i")),
            "bMailServiceExtraFont" => new ConfigItem(2092, "bMailServiceExtraFont", "textarea", "", _("Here we put the font in the form fontnametodisplay/yourfontname. It is useful for the font menu of ckeditor, for example : Abril/Abril Fatface")),
    ...
    private static function buildCategories()
    {
        return array(
            ...
            _('Map Settings') => ["sMapProvider", "sNominatimLink", "sGoogleMapKey", "iMapZoom", "iLittleMapZoom", "sISTusername", "sISTpassword"],
            ...
            _('Integration') => ["bMailServiceWithAddressPhone", "bMailServiceContentsExternalCssFont", "bMailServiceExtraFont", "sGoogleTrackingID", "bEnableGravatarPhotos", "bEnableGooglePhotos", "iRemotePhotoCacheDuration", "sNexmoAPIKey", "sNexmoAPISecret", "sNexmoFromNumber", "sOLPURL", "sOLPUserName", "sOLPPassword"],
