...
class SystemConfig
{
  ...
  {
    return array(
        "sLogLevel" => new ConfigItem(4, "sLogLevel", "choice", "100", _("Event Log severity to write, used by ORM and App Logs. sLogLevel >= ORM is set in debug mode."), "", json_encode(SystemConfig::getMonoLogLevels())),
        ...
        "iSearchIncludeGroupsMax" => new ConfigItem(2030, "iSearchIncludeGroupsMax", "text", "15", _("Maximum number of Groups")),
        "iSearchIncludeDepositsMax" => new ConfigItem(2031, "iSearchIncludeDepositsMax", "text", "5", _("Maximum number of Deposits")),
        "iSearchIncludePaymentsMax" => new ConfigItem(2032, "iSearchIncludePaymentsMax", "text", "5", _("Maximum number of Payments")),
        "iSearchIncludeAddressesMax" => new ConfigItem(2033, "iSearchIncludeAddressesMax", "text", "15", _("Maximum number of Addresses")),
        "bSearchIncludePastoralCare" => new ConfigItem(2060, "bSearchIncludePastoralCare", "boolean", "1", _("Search Pastoral Care")),
        "iSearchIncludePastoralCareMax" => new ConfigItem(2061, "iSearchIncludePastoralCareMax", "text", "5", _("Maximum number of Pastoral Care results")),
