...
class SystemConfig
{
    ...
    private static function buildConfigs()
  {
    return array(
        ...
        "bHSTSEnable" => new ConfigItem(20142,"bHSTSEnable","boolean","0",gettext("Require that this EcclesiaCRM2 Database is accessed over HTTPS")),
