...
class SystemConfig
{
    ...
    private static function buildConfigs()
  {
    return array(
        ...
        "sDatePickerPlaceHolder" => new ConfigItem(109, "sDatePickerPlaceHolder", "choice", "yyyy-mm-dd", gettext("For defining the date in Date-Picker, per default : yyyy-mm-dd, In French : dd/mm/yyyy for example."),'','{"Choices":["yyyy-mm-dd","dd/mm/yyyy"]}'),
  ...
  private static function buildCategories()
  {
    return array (
      ...
      gettext('Localization')  => ["sLanguage","bStateUnusefull","sDistanceUnit","sPhoneFormat","sPhoneFormatWithExt","sPhoneFormatCell","sDateFormatLong","sTimeEnglish","sTimeFormat","sDatePickerPlaceHolder","sDateFormatNoYear","sDateFormatShort","sDateTimeFormat","sDateFilenameFormat","sDatePickerFormat"],
