...
class SystemConfig
{
  ...
  private static function buildCategories()
  {
    return array (
      ...
      gettext('Map Settings')  => ["sGeoCoderProvider","sGoogleMapKey","sBingMapKey","sGMapIcons", "iMapZoom","iLittleMapZoom","sISTusername","sISTpassword"],
      ...
      gettext('Localization')  => ["sLanguage","sCurrency","bStateUnuseful","sDistanceUnit","sPhoneFormat","sPhoneFormatWithExt","sPhoneFormatCell","sDateFormatLong","sTimeEnglish","sTimeFormat","sDatePickerPlaceHolder","sDateFormatNoYear","sDateFormatShort","sDateTimeFormat","sDateFilenameFormat","sDatePickerFormat","sTimeZoneSet"],
