...
class SystemConfig
{
    ...
    private static function buildConfigs()
  {
    return array(
        ...
        "bStateUnuseful" => new ConfigItem(2050, "bStateUnuseful", "boolean", "0", gettext("Hide dropdown states when they are unusefull")),
  ...
  private static function buildCategories()
  {
    return array (
      ...
      gettext('Localization')  => ["sLanguage","bStateUnuseful","sDistanceUnit","sPhoneFormat","sPhoneFormatWithExt","sPhoneFormatCell","sDateFormatLong","sTimeEnglish","sTimeFormat","sDatePickerPlaceHolder","sDateFormatNoYear","sDateFormatShort","sDateTimeFormat","sDateFilenameFormat","sDatePickerFormat"],
