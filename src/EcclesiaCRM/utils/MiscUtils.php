...
class MiscUtils {
  ...
  public static function random_word( $length = 6 ) {
      $cons = array( 'b', 'c', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'p', 'r', 's', 't', 'v', 'w', 'x', 'z', 'ch', 'dr', 'gl', 'gh', 'gn', 'gr', 'ph', 'ps', 'sh', 'st', 'th', 'wh');
      $cons_cant_start = array( 'ck', 'cm', 'ds','ft', 'kr', 'ks', 'ls', 'lt', 'lr', 'mp', 'mt', 'ms', 'ng', 'ns','pt','rd', 'rg', 'rs', 'rt', 'ss', 'ts', 'tch');
