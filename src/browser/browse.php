...
<a class="new-folder" data-personid="<?= $user->getPersonId() ?>" data-toggle="tooltip" data-placement="top" data-original-title="<?= _("Create a Folder") ?>">
<span class="fa-stack fa-special-icon drag-elements">
...
<a class="trash-drop" data-personid="<?= $user->getPersonId() ?>" data-toggle="tooltip" data-placement="top" data-original-title="<?= _("Delete") ?>">
<span class="fa-stack fa-special-icon drag-elements">
...
<a class="folder-back-drop" data-personid="<?= $user->getPersonId() ?>" data-toggle="tooltip" data-placement="top" data-original-title="<?= _("Up One Level") ?>" <?= ( !is_null ($user) && $user->getCurrentpath() != "/")?"":'style="display: none;"' ?>>
  <span class="fa-stack fa-special-icon drag-elements">
