...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-info"><?= _("• Statitics about the persons, families ... who still have to be contacted by the church !<br>• The less the progress bars are, the better it is !") ?></div>
