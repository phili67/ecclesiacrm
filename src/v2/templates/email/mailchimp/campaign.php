    ...
    <div class="box">
      ...
      <div class="box-body">
        <p>
          ...
          <button id="sendCampaign" class="btn btn-app align-right bg-green <?= ( ( $campaign['status'] == "sent" || $campaign['status'] == "schedule" )?'hidden':'') ?>" data-listid="<?= $list_id ?>">
              ...
              <div class="row">
                  ...
                  <div class="col-md-2">
                       <div class="input-group">
                          ...
                          <input class="form-control date-picker input-sm" type="text" id="dateCampaign" name="dateCampaign"  value="<?= (isset($campaign[send_time]))?OutputUtils::change_date_for_place_holder($campaign[send_time]):"" ?>"
                                'maxlength="10" id="sel1" size="11"
                                'placeholder="<?= SystemConfig::getValue('sDatePickerPlaceHolder') ?>" <?= ($campaign['status'] == "schedule")?"":"disabled" ?>>
                        </div>
                  </div>
                  <div class="col-md-2">
                        <div class="bootstrap-timepicker">
                           <div class="form-group">
                              <div class="input-group">
                                 ...
                                 <input type="text" class="form-control timepicker input-sm" id="timeCampaign" name="timeCampaign" value="<?= (isset($campaign[send_time]))?OutputUtils::change_time_for_place_holder($campaign[send_time]):"00:00" ?>" <?= ($campaign['status'] == "schedule")?"":"disabled" ?>>
                              </div>
                            </div>
                         </div>
                     </div>
