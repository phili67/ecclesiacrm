...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
    <div>
        <h3 class="h4 mb-1"><i class="fas fa-user mr-2 text-success"></i><?= _("Person List") ?></h3>
        <p class="text-muted mb-0"><?= _("Persons missing Mailchimp email matches.") ?></p>
    </div>
...
<div class="card card-outline card-success shadow-sm">
    <div class="card-header">
        <h3 class="card-title mb-0"><i class="fas fa-table mr-1"></i><?= _("Person List") ?></h3>
    </div>
