...
function mailchimpManageListArgumentsArray ($listId,$mailchimp)
{
   ...
   $sPageTitle     = _('Email Audience')." : ". $list['name'].(($list['marketing_permissions'])?'  ('._("GDPR").')':'');
   $sPageTitleSpan = _('Email Audience')." : <span  id=\"ListTitle\">". $list['name'].(($list['marketing_permissions'])?'</span>  <span style="float:right">'._("GDPR"):'');
