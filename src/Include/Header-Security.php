...
$csp = array(
    "default-src 'self'",
    "script-src 'self' 'unsafe-eval' 'nonce-".SystemURLs::getCSPNonce()."' sidecar.gitter.im browser-update.org maps.googleapis.com www.bing.com  dev.virtualearth.net t.ssl.ak.dynamic.tiles.virtualearth.net cdnjs.cloudflare.com meet.jit.si 8x8.vc", /*'nonce-".SystemURLs::getCSPNonce()."' // replacement of : 'unsafe-inline' */
