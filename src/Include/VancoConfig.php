...
$VancoUrltoredirect = RedirectUtils::RedirectURL('CatchCreatePayment.php'); // Replace with the URL your customer's browser will be redirected to after making a TransparentRedirect API call
